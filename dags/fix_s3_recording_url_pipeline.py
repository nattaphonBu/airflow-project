...
COMMAND = 'python pronto_dashboard/manage.py fix_s3_recording_url --settings=pronto_dashboard.settings.' + ENVIRONMENT_SETTING
...
default_args = {
    ...
    'retries': 1,
    'retry__delay': timedelta(minutes=5),
    'on_failure_callback': send_alert_task_failure_to_slack
}

with DAG('fix_s3_recording_url_pipeline', default_args=default_args, schedule_interval='*/10 * * * *', catchup=False) as dag:
