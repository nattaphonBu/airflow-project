...
COMMAND = 'python pronto_dashboard/manage.py send_insights_report_email_notification --settings=pronto_dashboard.settings.' + ENVIRONMENT_SETTING


default_args = {
    'owner': 'ProntoTools',
    'description': 'send insight reports email notification',
...
with DAG('send_insights_reports_email_notification_pipeline', default_args=default_args, schedule_interval='20 * * * *', catchup=False) as dag:
    ...
    t2 = DockerOperator(
        task_id='send_insights_reports_email_notification_pipeline',
        auto_remove=True,
        image=IMAGE_NAME,
        api_version='auto',
        command=COMMAND,
