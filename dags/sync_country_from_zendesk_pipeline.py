...
COMMAND = 'python pronto_dashboard/manage.py sync_country_from_zendesk --settings=pronto_dashboard.settings.' + ENVIRONMENT_SETTING

default_args = {
    'owner': 'ProntoTools',
    'description': 'Sync country from zendesk at every 00:00',
...
with DAG('sync_country_from_zendesk_pipeline', default_args=default_args, schedule_interval="0 0 * * *", catchup=False) as dag:
